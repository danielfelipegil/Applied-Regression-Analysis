...
6. None of the above 	Inorrect 	0.00 	
...
All of the variance in Y is explained by the regression of Y on X  	With regards to ρxy=1, this statement is true.
The conditional variance of Y = 0 	With regards to ρxy=1, this statement is true.
The relationship between X & Y is perfectly linear  With regards to ρxy=1, this statement is true.
...
```The F statistic``` 	Correct 	0.33 	
```The confidence interval for the slope``` 	Inorrect 	0.00
